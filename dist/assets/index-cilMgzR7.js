...
function useVisualElement(Component, visualState, props, createVisualElement) {
  ...
  const wantsHandoff = reactExports.useRef(Boolean(props[optimizedAppearDataAttribute]));
...
const clamp = (min, max2, v) => Math.min(Math.max(v, min), max2);
const number = {
...
const { schedule: frame$1, cancel: cancelFrame, state: frameData, steps } = createRenderBatcher(typeof requestAnimationFrame !== "undefined" ? requestAnimationFrame : noop$1, true);
...
function addHoverEvent(node, isActive) {
  ...
  const handleEvent = (event, info) => {
    ...
    if (props[callbackName]) {
      frame$1.update(() => props[callbackName](event, info));
    }
  };
...
class PressGesture extends Feature {
      ...
      const handleKeydown = (keydownEvent) => {
        ...
        const handleKeyup = (keyupEvent) => {
          ...
          fireSyntheticPointerEvent("up", (event, info) => {
            ...
            if (onTap) {
              frame$1.update(() => onTap(event, info));
            }
          });
        };
        this.removeEndListeners();
  ...
  startPress(event, info) {
    ...
    if (onTapStart) {
      frame$1.update(() => onTapStart(event, info));
    }
  }
  checkPressEnd() {
    this.removeEndListeners();
  ...
  cancelPress(event, info) {
    ...
    if (onTapCancel) {
      frame$1.update(() => onTapCancel(event, info));
    }
  }
  mount() {
    const props = this.node.getProps();
...
function createAcceleratedAnimation(value, valueName, { onUpdate, onComplete, ...options }) {
  ...
  const safeCancel = () => {
    frame$1.update(cancelAnimation);
    resolveFinishedPromise();
    updateFinishedPromise();
  };
  animation.onfinish = () => {
  ...
  constructor(init2, options = {}) {
    ...
    this.updateAndNotify = (v, render = true) => {
      ...
      if (this.lastUpdated !== timestamp) {
        ...
        frame$1.postRender(this.scheduleVelocityCheck);
      }
    ...
    this.scheduleVelocityCheck = () => frame$1.postRender(this.velocityCheck);
  ...
  for (const key in target) {
    ...
    if (window.HandoffAppearAnimations && !value.hasAnimated) {
      ...
      if (appearId) {
        ...
        valueTransition.elapsed = window.HandoffAppearAnimations(appearId, key, value, frame$1);
...
class VisualElementDragControls {
  ...
  start(originEvent, { snapToCursor = false } = {}) {
    ...
    const onStart = (event, info) => {
      ...
      if (onDragStart) {
        frame$1.update(() => onDragStart(event, info), false, true);
      }
  ...
  stop(event, info) {
    ...
    if (onDragEnd) {
      frame$1.update(() => onDragEnd(event, info));
    }
  }
  cancel() {
    this.isDragging = false;
...
const asyncHandler = (handler) => (event, info) => {
  if (handler) {
    frame$1.update(() => handler(event, info));
  }
};
  ...
  createPanHandlers() {
    ...
    return {
      ...
      onEnd: (event, info) => {
        delete this.session;
        if (onPanEnd) {
          frame$1.update(() => onPanEnd(event, info));
        }
      }
    };
  }
...
class VisualElement {
  constructor({ parent, props, presenceContext, reducedMotionConfig, visualState }, options = {}) {
    ...
    this.scheduleRender = () => frame$1.render(this.render, false, true);
  ...
  bindToMotionValue(key, value) {
    ...
    const removeOnChange = value.on("change", (latestValue) => {
      ...
      this.props.onUpdate && frame$1.update(this.notifyUpdate, false, true);
...
function useForceUpdate() {
  ...
  const deferredForceRender = reactExports.useCallback(() => frame$1.postRender(forceRender), [forceRender]);
...
const PresenceChild = ({ children: children2, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode }) => {
  ...
  if (mode === "popLayout") {
    children2 = reactExports.createElement(PopChild, { isPresent }, children2);
  }
...
function timeout(callback, delay2, time) {
  var t = new Timer();
...
function Bars({ data: data2 = [], progress: progress2 = 0 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bars", children: data2.map(({ metric, value, delta }) => {
    const v = Number(value ?? 0);
    const w = Math.max(6, Math.min(100, v));
    const up = Number(delta ?? 0) > 0;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: metric }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `track ${up ? "up" : "down"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fill", style: { width: `${w}%` } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "val", children: v })
      ] })
    ] }, metric);
  }) });
}
...
function Counter({ value = 0, label = "", duration = 900 }) {
  ...
  reactExports.useEffect(() => {
    ...
    let raf;
    const tick = (t) => {
      const p = Math.min(1, (t - start2) / duration);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "counter", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "counter-value", children: n }),
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "counter-label", children: label })
  ] });
}
function Ambient() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        inset: 0,
        zIndex: -1,
        background: "radial-gradient(1200px 800px at 60% 20%, rgba(255,255,255,.10) 0%, rgba(255,255,255,0) 60%), radial-gradient(900px 600px at 20% 80%, rgba(255,230,150,.12) 0%, rgba(255,230,150,0) 55%), linear-gradient(180deg, #0e1430 0%, #141d46 45%, #0f1a3b 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "100%", height: "100%", style: { mixBlendMode: "screen", opacity: 0.35 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { id: "s", r: "1.2", fill: "white" }) }),
        Array.from({ length: 220 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "use",
          {
            href: "#s",
            x: Math.random() * 2e3,
...
function Leaderboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "leaderboard", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lb-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: rank.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        className: "lb-row",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lb-rank", children: i + 1 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lb-name", children: r.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lb-score", children: Math.round(r.score) })
        ]
      },
      r.name
    )) })
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vhs", ref: heroRef, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bars, { data: sepCounts.list || [], progress: progress2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bars, { data: octCounts.list || [], progress: progress2 }),
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "2rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: 0 }, children: "Something tripped on the tape." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { opacity: 0.7 }, children: "Reload, or ping the goblin who wrote this." })
      ] });
    }
    return this.props.children;
  }
}
ReactDOM.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }));
export {
