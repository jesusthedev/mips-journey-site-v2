const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GlitchLayer-B_W1zaoC.js","assets/GlitchLayer-C0dWx6zP.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
function Bars({ data: data2 = [], progress: progress2 = 0 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bars", children: items.map((d, i) => {
    const label = String(d?.metric ?? d?.name ?? `Item ${i + 1}`);
    const value = Number(d?.value ?? d?.count ?? 0);
    const trend = Number(d?.trend ?? 0);
    const color2 = trend > 0 ? "var(--bar-up)" : trend < 0 ? "var(--bar-down)" : "var(--bar-flat)";
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bar-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bar-label", children: label }),
...
const GlitchLayer = React.lazy(() => __vitePreload(() => import("./GlitchLayer-B_W1zaoC.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
//# sourceMappingURL=index-6bnwpIOZ.js.map
